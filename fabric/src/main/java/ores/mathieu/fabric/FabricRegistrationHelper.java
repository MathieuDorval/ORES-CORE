...
//
// Description: Fabric implementation of the registration service.
// Hooks into Fabric API registries for biome modifications, flammability,
// fuel values, and dynamic feature/carver placement.
//
// Author: __mathieu
// Version: 26.1.100
//
...
public class FabricRegistrationHelper implements RegistrationHelper {
    ...
    public void registerFuels(Map<Item, Integer> fuels) {
        ...
        OresCoreCommon.LOGGER.debug("[ORES CORE] {} fuels registered via Fabric API.", fuels.size());
    }
    ...
    public void registerBiomeModification(int veinIndex, VeinConfig config) {
        ...
        OresCoreCommon.LOGGER.debug("[ORES CORE] Biome modification registered for vein {}.", veinIndex);
    }
}
