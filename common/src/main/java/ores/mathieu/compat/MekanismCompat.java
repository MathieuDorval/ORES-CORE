...
//
// Description: Handles compatibility and integration with the Mekanism mod.
//
// Author: __mathieu
// Version: 26.1.001
//
        ...
        try {
            ...
            if (registryHolder.isPresent()) {
                ...
                if (holder instanceof net.minecraft.core.Holder.Reference<?> ref) {
                    ...
                    OresCoreCommon.LOGGER.debug("[ORES CORE DEBUG] Registered Mekanism chemical: {}", id);
                }
            } else {
                OresCoreCommon.LOGGER.debug("[ORES CORE DEBUG] Mekanism chemical registry not found, skipping API registration for {}", id);
            }
