...
//
// Description: DataPack query utility parsing standard vanilla and modded tags.
//  Resolves abstraction mappings enabling compatibilities between dynamic 
// Ores Core materials with the standard Minecraft tagging ecosystem.
//
// Author: __mathieu
// Version: 26.1.100
//
...
public class TagScanner {
    ...
    public static void init() {
        ...
        OresCoreCommon.LOGGER.debug("[ORES CORE] Starting manual tag scan for tool requirement and mining level tags...");
        ...
        OresCoreCommon.LOGGER.debug("[ORES CORE] TagScanner scanned {} tags in {}ms. Found tags for {} blocks.", scanned.size(), System.currentTimeMillis() - start, OBJECT_TO_TAGS.size());
    ...
    private static void scanTag(Identifier tagLoc, Queue<Identifier> queue) {
        ...
        try {
            ...
            OresCoreCommon.LOGGER.warn("[ORES CORE] TagScanner failed to parse {}", path);
        }
    }
