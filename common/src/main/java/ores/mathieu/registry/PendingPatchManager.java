...
public class PendingPatchManager {
    ...
    private static void initFields() {
        ...
        try {
            ...
            fieldsInit = true;
            OresCoreCommon.LOGGER.debug("[ORES CORE DEBUG] PendingPatchManager: reflection ready ({} Properties fields, destroy={}, resistance={}).",
    ...
    public static void enqueue(Block oreBlock, String baseBlockId, float hardnessFactor, float resistanceFactor) {
        ...
        OresCoreCommon.LOGGER.debug("[ORES CORE DEBUG] Queued deferred patch for {} (base: {})", oreBlock, baseBlockId);
    }
    ...
    public static void applyAll() {
        ...
        for (DeferredOrePatch patch : PENDING) {
            ...
            if (baseId == null) {
                OresCoreCommon.LOGGER.warn("[ORES CORE WARNING] Invalid base block ID '{}' — skipping.", patch.baseBlockId());
                skipped++;
                continue;
            }
            ...
            if (baseBlock == null || baseBlock == net.minecraft.world.level.block.Blocks.AIR) {
                OresCoreCommon.LOGGER.warn("[ORES CORE WARNING] Base block '{}' not found after registry freeze — ore {} left with stone fallback.",
            ...
            try {
                ...
                OresCoreCommon.LOGGER.debug("[ORES CORE DEBUG] Deeply applied deferred patch {} → {} (hardness={}, resistance={})",
        ...
        OresCoreCommon.LOGGER.debug("[ORES CORE DEBUG] Deferred patches complete: {} applied, {} skipped.", applied, skipped);
        PENDING.clear();
    }
}
