...
//
// Description: Specialized CarverConfiguration for ore vein carvers. 
// Similar to VeinFeatureConfiguration, it stores a reference index 
// to the global vein configuration map, allowing the world carver 
// to apply custom material replacement and shape logic during the 
// world carving phase based on dynamic TOML settings.
//
// Author: __mathieu
// Version: 26.1.100
//
