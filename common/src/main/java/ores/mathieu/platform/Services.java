...
//
// Description: Service locator pattern handling multi-loader
// abstractions for cross-platform (NeoForge/Fabric) loading of 
// config paths and registry resources.
//
// Author: __mathieu
// Version: 26.1.100
//
